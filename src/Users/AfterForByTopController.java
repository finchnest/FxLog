...
public class AfterForByTopController implements Initializable {
        ...
        rating.ratingProperty().addListener(new ChangeListener<Number>() {
            ...
            public void changed(ObservableValue<? extends Number> ov, Number t, Number t1) {
               rating_value=t1.intValue();
                ...
                proo=ByTopController.provid;
                fooo=ByTopController.food;
    ...
    private void saveAfterData(MouseEvent event) throws IOException {
        ...
        cust=new ByTopController().customer;
         
        String concat=comment+"~"+friend+"~"+rate+"~"+cust+"~"+proo+"~"+fooo;

        Socket socket=new Socket("127.0.0.1",19898);
