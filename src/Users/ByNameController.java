...
public class ByNameController implements Initializable {
...
//            System.out.println(food);
        ...
        byNameTable.setItems(nameSList);
        buyButt.disableProperty().bind(Bindings.isEmpty(byNameTable.getSelectionModel().getSelectedItems()));
    ...
    private void runBuy(MouseEvent event) {
        try{
            ...
            FoodTableModel fmodel=byNameTable.getSelectionModel().getSelectedItems().get(0);
